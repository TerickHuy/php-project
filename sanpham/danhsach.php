                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($query)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="index.php?page_layout=sua&id=<?php echo $row[
                                        'prd_id'
                                    ]; ?>">Sửa</a>

                                    <a onclick="return Del('<?php echo $row[
                                        'prd_name'
                                    ]; ?>')" class="btn btn-danger" href="index.php?page_layout=xoa&id=<?php echo $row[
    'prd_id'
]; ?>">Xóa</a>
                                </td>
                            </tr>
        ...
        <div class="card-footer d-flex justify-content-between">
            ...
            <?php if (isset($_POST['sbm']) && !empty($_POST['search'])) { ?>
